...
namespace OBeautifulCode.CodeGen.ModelObject.Recipes
{
        ...
        where T : class
    {
        ...
        /// This object.
        /// </returns>
        public EquatableTestScenarios<T> AddScenarios(
            EquatableTestScenarios<T> equatableTestScenarios)
        {
            new { equatableTestScenarios }.AsTest().Must().NotBeNull();

            lock (this.lockScenarios)
            {
                this.scenarios.AddRange(equatableTestScenarios.scenarios);
            }
        ...
        /// This object.
        /// </returns>
        public EquatableTestScenarios<T> RemoveAllScenarios()
        {
            lock (this.lockScenarios)
            {
