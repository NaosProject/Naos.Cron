...
namespace Naos.Cron.Test
{
    ...
    public class ScheduleCronConverterTests
    {
        ...
        public void GetCronExpressionFromSchedule_UnsupportedSchedule_Throws()
        {
            ...
            var ex = Assert.Throws<NotSupportedException>(() => ScheduleCronConverter.GetCronExpressionFromSchedule(schedule));
        ...
        public void GetCronExpressionFromSchedule_Minutely_Works()
        {
            ...
            var cron = ScheduleCronConverter.GetCronExpressionFromSchedule(schedule);
            Assert.Equal("* * * * *", cron);
        }
