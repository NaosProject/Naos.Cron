[![Build status](https://ci.appveyor.com/api/projects/status/github/NaosProject/Naos.Cron?branch=master&svg=true)](https://ci.appveyor.com/project/Naos-Project/naos-cron)
